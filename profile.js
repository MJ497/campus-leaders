...
// form inputs (declared early so populateProfile can safely reference them)
let inputFirst, inputLast, inputPosition, inputEmail, inputPhone, inputSchool, inputYear, inputAssoc, inputState, inputBio, inputImage, inputImageName;
...
inputFirst = document.getElementById('input-firstName');
inputLast = document.getElementById('input-lastName');
inputPosition = document.getElementById('input-position');
inputEmail = document.getElementById('input-email');
inputPhone = document.getElementById('input-phone');
inputSchool = document.getElementById('input-schoolName');
inputYear = document.getElementById('input-yearHeld');
inputAssoc = document.getElementById('input-association');
inputState = document.getElementById('input-stateName');
inputBio = document.getElementById('input-bio');
inputImage = document.getElementById('input-image');
inputImageName = document.getElementById('input-image-name');
